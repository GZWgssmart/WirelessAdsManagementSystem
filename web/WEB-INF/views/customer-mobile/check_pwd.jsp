...
<html>
<head>
    <title>用户审核密码修改-青岛宝瑞媒体发布系统</title>
    <meta charset="UTF-8"/>
    ...
    <script src="<%=path %>/js/customer/check_pwd.js"></script>
...
<div class="easyui-navpanel">
    ...
    <div id="errMsg"></div>
    <form:form id="updateForm" method="post" modelAttribute="customer" cssClass="mob-form">
        <span style="text-align: center; font-weight:bold; font-size: 14px;">修改审核密码</span>
            <div><input type="password" name="checkPwd" label="原密码：" class="easyui-validatebox easyui-textbox"
                           data-options="required:true,validType:'length[6,20]',novalidate:true" style="width: 100%;"/>
            </div>
            <div><input id="newPwd" type="password" name="newPwd" label="新密码：" class="easyui-validatebox easyui-textbox"
                           data-options="required:true,validType:'length[6,20]',novalidate:true" style="width: 100%;"/>
            </div>
