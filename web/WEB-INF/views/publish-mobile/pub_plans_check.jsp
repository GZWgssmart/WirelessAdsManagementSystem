...
<head>
    ...
    <script src="<%=path %>/js/publish/pub_plans_check-mobile.js"></script>
</head>
<body>
<div id="planCheckLayer" class="layer"></div>
<div class="easyui-navpanel">
    ...
    <div class="easyui-dialog" id="checkPwdWin" data-options="title:'提交审核',resizable:false,mode:true,closed:true">
        <form id="checkPwdForm" class="mob-form">
            <input id="toCheckPlanId" type="hidden" name="id" />
            <div><input id="checkPwd" type="password" name="checkPwd" label="审核密码：" class="easyui-validatebox easyui-textbox" data-options="required:true,novalidate:true" style="width:100%;"/>
            </div>
            <div>
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="cancelCheckPwd();">取消</a>
                &nbsp;&nbsp;
                <a href="javascript:void(0);" class="easyui-linkbutton" onclick="conCheckPwd();">确认</a>
            </div>
